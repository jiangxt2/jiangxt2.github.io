...
In the GitHub repository settings, select GitHub Actions as the Pages source. Pushes to `main` publish automatically, while pull requests can use the workflow run and local preview to validate changes before merging.
